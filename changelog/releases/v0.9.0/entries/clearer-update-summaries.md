...
before version transitions or diagnostic notes, including while skills are
actively updating. When every skill is already current, the command prints only
the summary count.
